                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <?php // while($row2 = mysqli_fetch_array($fromuser)){?>
                            <span class="hidden-xs"> Administrator <?php// echo ucfirst($row2['jina']); ?><?php// }?></span>
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p> Administrator
                                    <?php
                                   // $fromuser = mysqli_query($dbconfig,"select jina from sale where password='rama123'");
                                   // while($row3 = mysqli_fetch_array($fromuser)){?>
                                        <?php// echo ucfirst($row3['jina']); ?><?php// }?>
                                    <small></small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                    ...
                                    <?php
                                    /*
                                    $query =mysqli_query($dbconfig,"SELECT EXTRACT(MONTH FROM start_time) as Month, id, user_name as unique_logins ,application as number_access,application as application_name,clusters_cluster_id as Total_system_hours from monitored_info group by EXTRACT(MONTH FROM start_time), user_name")or die("this code is not running");
                                    ?>
