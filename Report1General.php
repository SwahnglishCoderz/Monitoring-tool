    ...
    <div class="content-wrapper">
       ...
       <div class="box-body">
                            <div class="table-responsive">
                                ...
                                <table class="gridtable">
                                    <?php
                                    $query2 =mysqli_query($dbconfig,"SELECT clusters_cluster_id, EXTRACT(MONTH FROM start_time) as Month, EXTRACT(WEEK FROM start_time), COUNT(user_name) as unique_logins, COUNT(application) as number_access, application as application_name, SUM(TIME_TO_SEC(`Total_system_hours`))/60 as Total_system_hours from monitored_info WHERE clusters_cluster_id = '$cluster_id' group by EXTRACT(MONTH FROM start_time), EXTRACT(WEEK FROM start_time),application")or die("this code is not running");
                                    ?>
