                       ...
                       <div class="box-body">
                            <div class="table-responsive">
                                <table class="gridtable">
                                    <?php
                                    $query =mysqli_query($dbconfig,"SELECT EXTRACT(MONTH FROM start_time) as Month, EXTRACT(WEEK FROM start_time) as week, start_time as date, id, user_name as unique_logins, count(application) as number_access,application as application_name, SUM(TIME_TO_SEC(`Total_system_hours`))/60 as Total_system_hours from monitored_info group by EXTRACT(MONTH FROM start_time), EXTRACT(WEEK FROM start_time), user_name, application ")or die("this code is not running");
                                    ?>
