            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="box box-primary">
                        ...
                        <form name="form_date" action="?" role="form" method="POST" >
                                    ...
                                    <div class="row">
                                        <div class="form-row">
                                            <div class="form-group col-md-2">
                                                <div class="form-group">
                                                    <div class="input-group date fj-date">
                                                        <input type="date" name="from" class="form-control" placeholder="From"><span class="input-group-addon">
                                            ...
                                            <div class="form-group col-md-2">
                                                <div class="form-group">
                                                    <div class="input-group date fj-date">
                                                        <input type="date"  name="to" class="form-control" placeholder="To"><span class="input-group-addon">
                                                            <i class="glyphicon glyphicon-calendar"></i></span>
                                                    </div>
                                                </div>
                                                <script>
                                            ...
                                            <div class="form-group col-md-2">
                                                <input name="submit"  type="submit" class="btn btn-default " value="Search"/>
                                            </div>
                       ...
                       <div class="box-body">
                            <div class="table-responsive">
                                    <?php
                                    $query =mysqli_query($dbconfig,"select* from monitored_info where start_time between '$from' and '$to'")or die("this code is not running");
                                    ?>
