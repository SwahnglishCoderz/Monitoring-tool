                    ...
                    <div class="box box-primary">
                                    ...
                                    <div class="row">
                                        <div class="form-row">
                                           ...
                                           <div class="form-group col-md-3">
                                                ...
                                                <input  type="text" name="username" placeholder="Search by User Name or ID" class="form-control" style="border-radius:10px;"> 
                                          </div>
                       ...
                       <div class="box-body">
                            <div class="table-responsive">
                                    <?php
                                    $query =mysqli_query($dbconfig,"select* from monitored_info where user_name LIKE '%$username%'")or die("this code is not running");
                                    ?>
