...
mysqli_select_db($dbconfig,"ci_db") or die("cannot select DB");
    ...
    <header class="main-header">
        ...
        <a href="dashboard.php" class="logo">
            ...
            <span class="logo-lg"><b>CL_</b>MONITOR</span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="#" data-toggle="modal" data-target="#profit">
                        <i class="fa fa-bar-chart"></i> <span>View General Report</span>
                    </a>
                </li>
                
                <li>
                    <a href="dashboard.php">
                        <i class="fa fa-database"></i> <span>View Monthly Report</span>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div>
                                       <a href="general_report.php" class="btn btn-success  tooltop" role="button" data-toggle="modal" data-target="#addstock">Total No. of Unique Logins, Application Access & Hours of App Use</a>
                                        ...
                                        <a href="daily_application.php" class="btn btn-success  tooltop" role="button" data-toggle="modal" data-target="#update">Number of Application Access Per User</a>
                                        <a href="daily_user_log.php" class="btn btn-success  tooltop" role="button" data-toggle="modal" data-target="#update">Daily User Log</a>
                                        <a href="search.php" class="btn btn-success  tooltop" role="button" data-toggle="modal" data-target="#update">Search by Name</a>
                                        <a href="search_date.php" class="btn btn-success  tooltop" role="button" data-toggle="modal" data-target="#update">Search by Date</a><br></br>
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="gridtable">
                                    <?php
                                    $query =mysqli_query($dbconfig,"select EXTRACT(MONTH FROM start_time) as Month, EXTRACT(WEEK FROM start_time) as week, (select distinct user_name) as unique_login, COUNT( application) as number_access,sum(clusters_cluster_id) as Total_system_hours from monitored_info group by EXTRACT(MONTH FROM start_time), EXTRACT(WEEK FROM start_time),user_name")or die("this code is not running");
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <th>TOTAL APPLICATION USAGE HOURS</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
            ...
            echo"no corrent month value";
              ...
              $same_row = false;
                        for ($i = 0; $i < count($presentation); $i++){
                            $data = $presentation[$i];
                            if($data['week'] == $row2['week'] && $data['user'] == $row2['unique_login'] && $data['month'] == $month){
                                $same_row = true;
                                $data['access'] += $row2['number_access'];
                                $data['time'] += $row2['Total_system_hours'];
                                break;
                            }
                        }
                        echo 'pushing';
                        if($same_row == false){
                            ...
                            $presentation[] = [
                                'week' => $row2['week'],
                                'month' => $month,
                                'user' => $row2['unique_login'],
                                'access' => $row2['number_access'],
                                'time' => $row2['Total_system_hours']
                           ];
                        }
